		...
		<div id="page-wrapper">
				...
				<header id="header">
					...
					<nav id="nav">
						<ul>
							...
							<li><a class="button special" href="/nuevaoferta">Nueva Subasta</a></li>
			...
			<!-- Banner -->
				<section id="banner">
					...
					<form method="post" action="/nuevasubasta">
									<div class="row uniform 50%">
										<div class="12u$">
											<input type="text" name="title" id="title" value="" placeholder="Añade un título" required>
										</div>
										<div class="6u 12u$(xsmall)">
											<input type="text" name="userMax" id="userMax" value="" pattern="[0-9]{1,5}" placeholder="Añade un número máximo de usuarios" required>
										</div>
										...
										<div class="12u$">
											<ul class="actions">
												<li><input type="submit" value="Añadir subasta" class="special"></li>
